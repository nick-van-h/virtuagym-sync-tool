CREATE TABLE `u93257p88111_vst`.`settings` ( `id` INT(11) NOT NULL AUTO_INCREMENT , `user_id` INT(11) NOT NULL , `variable` VARCHAR(255) NOT NULL , `value_str` VARCHAR(255) NULL , `value_int` INT(11) NULL , `type` VARCHAR(3) NOT NULL COMMENT 'str/int' , PRIMARY KEY (`id`), INDEX (`user_id`)) ENGINE = InnoDB;
