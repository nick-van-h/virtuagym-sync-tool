...
class Crypt 
{
     ...
     */
    function generateAndSetInitialKey($password) {
    ...
    function getEncryptedKey($password) {
        $key_enc = openssl_encrypt($this->session->getKey(), SELF::CIPHERING, $password, SELF::OPTIONS, $this->encryption_iv);
        return $key_enc;
    }
     ...
     */
    function decryptAndSetKey($encryptedKey, $password) {
